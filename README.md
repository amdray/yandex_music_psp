...
3. Скопируйте каталог приложения в `PSP/GAME/YMPSP/` на Memory Stick.
...
Исходный код, логотип YMPSP и файл шрифта `fonts/ui.cbmf` распространяются по лицензии MIT — см. [LICENSE](LICENSE).
