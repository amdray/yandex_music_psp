...
static const char *s_locale_strings[LOCALE_COUNT][LOCALE_LANG_COUNT] = {
    ...
    [LOCALE_MENU_SETTINGS] = { "Settings", "Настройки" },
    [LOCALE_MENU_AUDIO_QUALITY] = { "Quality", "Качество" },
    [LOCALE_MENU_AUTOPLAY] = { "Autoplay on startup", "Автозапуск трека" },
    [LOCALE_QUALITY_NORMAL] = { "Normal", "Нормальное" },
    [LOCALE_QUALITY_HIGH] = { "High", "Высокое" },
    [LOCALE_SETTING_OFF] = { "Off", "Выкл" },
    [LOCALE_SETTING_ON] = { "On", "Вкл" },
    ...
    [LOCALE_MENU_SEARCH]   = { "Search", "Поиск" },
    [LOCALE_SCREEN_SEARCH] = { "Search", "Поиск" },
    [LOCALE_MENU_HELP]   = { "Help", "Помощь" },
    [LOCALE_SCREEN_HELP] = { "Help", "Помощь" },
    [LOCALE_HELP_SELECT] = { "Select", "Выбрать" },
    [LOCALE_HELP_BACK] = { "Back", "Назад" },
    [LOCALE_HELP_PLAY_PAUSE] = { "Play / pause", "Играть / пауза" },
    [LOCALE_HELP_STOP] = { "Stop", "Стоп" },
    [LOCALE_HELP_LIKE] = { "Like", "Лайк" },
    [LOCALE_HELP_SEEK] = { "Track; hold to seek", "Трек; удерживать для перемотки" },
    [LOCALE_HELP_NOTE] = { "Next EQ preset", "Следующий профиль EQ" },
    [LOCALE_MENU_MEMORY] = { "Memory", "Память" },
    [LOCALE_SCREEN_MEMORY] = { "Memory", "Память" },
